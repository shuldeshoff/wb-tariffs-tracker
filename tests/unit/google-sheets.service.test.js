...
const mockTariffsRepository = tariffsRepository;
const mockGoogle = google;
describe("GoogleSheetsService", () => {
    ...
    describe("updateAllSheets", () => {
        ...
        it("должен корректно обрабатывать null значения дат", async () => {
            const tariffsWithNullDates = [
                Object.assign(Object.assign({}, mockTariffs[0]), { dt_next_box: null, dt_till_max: null }),
            ];
